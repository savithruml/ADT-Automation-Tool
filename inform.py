...
def send_mail(mail_id, file_download):
	...
	sender_mail = 'itzetaboulder@gmail.com'
	receiver_mail = mail_id
	mesg = '\nBelow are the scrubbed files\n'
    
	try:
		msg = MIMEMultipart()
		msg['From'] = 'ITZetaBoulder@gmail.com'
		msg['To'] = 'E-Mailers'
		...
		smtp_session.ehlo()
		smtp_session.login(sender_mail, 'ZetaAdminMe123')
...
def message_Twilio(to_number):
    ...
    sid = "AC4e45219ecfc768c5548964cf69f1118d"
    token = "591a88cc435bbe2ac192f938ac03d534"

    client = TwilioRestClient(sid, token)
    body = '\nADT FILE SCRUB COMPLETED'
    
    client.messages.create(to = to_number, from_= '+17206132910',
                            body=body,)
...
def call_Twilio(to_number):
	...
	call = client.calls.create(to='+17208768596', from_='+17206132910',
